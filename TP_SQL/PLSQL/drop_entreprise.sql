...
DROP PROCEDURE AUGMENT_EMPLOYE;

DROP PROCEDURE INFOSALAIRE;

DROP PROCEDURE baissePrixProduit;

DROP PROCEDURE totalCdeCommerciaux;

DROP PROCEDURE totalCdeCommerciaux2;
