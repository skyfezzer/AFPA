...
public class TestEmploye3Emprunts {
	...
	public static void main(String[] args) {
		TestEmploye3Emprunts testProgram = new TestEmploye3Emprunts();
		testProgram.init();
	...
	private void start() {
		try {
			System.out.println("On va créer plusieurs emprunt avec un Employé qui est en règle.");
			Employe emp = (Employe) utilisateurDAO.findByKey(16);
			System.out.println("L'employé : \n\t" + emp);
			List<Pret> prets = pretDAO.findAllByUtilisateur(emp);
