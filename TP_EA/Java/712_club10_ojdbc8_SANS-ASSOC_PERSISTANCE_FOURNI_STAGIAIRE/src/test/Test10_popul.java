...
/**
 * @author xav
 *Important, dans le fichier de config Hibernate, vous êtes en en "update"   (ou "create" (qui passe encore))
...
public class Test10_popul
{
	...
	try {
		...
		session.persist(e1);  System.out.println("entraineur Valeur d'identifiant :"+ e1.getIdE());
		session.persist(e2);  System.out.println("entraineur Valeur d'identifiant :"+ e2.getIdE());
		session.persist(e3);  System.out.println("entraineur Valeur d'identifiant :"+ e3.getIdE());
		...
		System.out.println("-----------------------------");
		session.persist(s1);  System.out.println("sport Valeur d'identifiant :"+ s1.getIdS());
		session.persist(s2);  System.out.println("sport Valeur d'identifiant :"+ s2.getIdS());
		session.persist(s3);  System.out.println("sport Valeur d'identifiant :"+ s3.getIdS());
